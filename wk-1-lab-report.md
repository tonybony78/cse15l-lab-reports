...
Afterwards, open up VSCode and open a terminal either by holding the Ctrl + ' keys or hovering over the Terminal dropdown at the top of the screen and clicking New Terminal like this.
![Image](https://cdn.discordapp.com/attachments/1064716019156930640/1064739204103426078/image.png)
Then, hold the Ctrl + Shift + P keys to open VSCode's command palette, type in "-Select Default Profile", and click on Git Bash. It should appear like this on your screen.
